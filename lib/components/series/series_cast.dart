...
class SeriesCastSection extends ConsumerWidget {
  final int tvId;

  const SeriesCastSection({super.key, required this.tvId});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final creditsAsync = ref.watch(tvSeriesCreditsProvider(tvId));
